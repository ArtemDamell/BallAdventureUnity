...
public class PlayerController : MonoBehaviour
{
    ...
    /// <summary>
    /// Sets the ground state of the object.
    /// </summary>
    /// <param name="isGround">The ground state to set.</param>
    ...
    /// <summary>
    /// Sets the game over state to the given boolean value.
    /// </summary>
    /// <param name="gameOver">The boolean value to set the game over state to.</param>
    ...
    /// <summary>
    /// Sets the value of the _gotEnergy field.
    /// </summary>
    /// <param name="gotEnergy">The value to set _gotEnergy to.</param>
    ...
    /// <summary>
    /// This method is used to rotate the camera around the player based on the input from the keyboard.
    /// </summary>
    ...
    /// <summary>
    /// This method handles the movement of the player character, including forward and backward movement, as well as jumping.
    /// </summary>
